...
module.exports = {
    ...
    body: p => `
        (module joystick (layer F.Cu)
            ...
            (pad X thru_hole circle (at 0 -8.6) (size 1.524 1.524) (drill 0.762) (layers *.Cu *.Mask) ${p.net.A.str})
            (pad Y thru_hole circle (at 8.6 0) (size 1.524 1.524) (drill 0.762) (layers *.Cu *.Mask) ${p.net.B.str})
